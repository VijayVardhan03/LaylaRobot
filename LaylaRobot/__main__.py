...
PM_START_TEXT = """
Hello, I'M Evil Pikachu
`ɪ'ᴍ ʜᴇʀᴇ ᴛᴏ ʜᴇʟᴘ ʏᴏᴜ ᴍᴀɴᴀɢᴇ ʏᴏᴜʀ ɢʀᴏᴜᴘꜱ! ʜɪᴛ` /help
Maintained by @Vijay_61 ❤
"""

buttons = [
    [
        InlineKeyboardButton(
            text="➕️ ᴀᴅᴅ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ➕️", url="t.me/EvilPikachuRoBot?startgroup=true"),
    ],E
    [
        InlineKeyboardButton(text="ᴀʙᴏᴜᴛ", callback_data="layla_"),
        InlineKeyboardButton(
            text="ꜱᴜᴘᴘᴏʀᴛ", url=f"https://t.me/https://t.me/evilpikachubotchat}"
        ),
    ],
    [
...
Powered by :- [Chat](t.me/evilpikachubotchat)"""

layla_IMG = "https://telegra.ph/file/5165112bb0c2a2a5c319b.jpg"

DONATE_STRING = """Heya, glad to hear you want to donate!
 You can support the project [Vijay](t.me/Vijay_61) \
 Supporting isnt always financial! [Chat](t.me/evilpikachubotchat) \
